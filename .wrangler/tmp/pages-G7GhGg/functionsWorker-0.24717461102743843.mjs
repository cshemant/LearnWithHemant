...
function buildRoleFits(ctx) {
  ...
  const has = /* @__PURE__ */ __name((items) => items.some((item) => detectedSkills.includes(item) || lower.includes(item)), "has");
  const proven = /* @__PURE__ */ __name((items) => items.some((item) => provenSkills.includes(item)), "proven");
  const roles = [
    {
...
function buildAdvancedSections(context) {
  ...
  const getPct = /* @__PURE__ */ __name((name) => {
...
// ../.wrangler/tmp/pages-G7GhGg/functionsRoutes-0.026670875592840093.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-Wv3r5o/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-Wv3r5o/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.24717461102743843.mjs.map
